...
import bitfusion.src.benchmarks.axcore_bench as axcore
...
def get_bench_nn_axcore(bench_name, batch_size):
    if bench_name == 'opt_125m':
        return create_net(bench_name, axcore.opt_125m, batch_size)
    elif bench_name == 'opt_350m':
        return create_net(bench_name, axcore.opt_350m, batch_size)
    elif bench_name == 'opt_1_3b':
        return create_net(bench_name, axcore.opt_1_3b, batch_size)
    elif bench_name == 'opt_2_7b':
        return create_net(bench_name, axcore.opt_2_7b, batch_size)
    elif bench_name == 'opt_6_7b':
        return create_net(bench_name, axcore.opt_6_7b, batch_size)
    elif bench_name == 'opt_13b':
        return create_net(bench_name, axcore.opt_13b, batch_size)
    elif bench_name == 'opt_66b':
        return create_net(bench_name, axcore.opt_66b, batch_size)
